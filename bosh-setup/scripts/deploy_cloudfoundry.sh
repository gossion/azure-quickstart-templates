...
bosh upload release REPLACE_WITH_DIEGO_RELEASE_URL --skip-if-exists
bosh upload release REPLACE_WITH_ETCD_RELEASE_URL --skip-if-exists
bosh upload release REPLACE_WITH_GARDEN_RELEASE_URL --skip-if-exists
bosh upload release REPLACE_WITH_CFLINUXFS2_RELEASE_URL --skip-if-exists
