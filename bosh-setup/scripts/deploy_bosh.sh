...
sed -i -e "s/REPLACE_WITH_DIRECTOR_UUID/$(bosh status --uuid)/" ./example_manifests/cf-deployment.yml
sed -i -e "s/REPLACE_WITH_DIRECTOR_UUID/$(bosh status --uuid)/" ./example_manifests/diego-deployment.yml
